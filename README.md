# (PaddlePaddle) SwinIR: Image Restoration Using Swin Transformer
This repository is the **PaddlePaddle** implementation of SwinIR: Image Restoration Using Shifted Window Transformer
...
Paddle model download: https://pan.baidu.com/s/1fAulSeLpebaa41oMdSLynQ?pwd=5sns 提取码: 5sns

Paddle training codes will be released soon.

<p align="center">
<img width="1200" src="figs/swinir_pytorch_paddle_results.png">
</p>
